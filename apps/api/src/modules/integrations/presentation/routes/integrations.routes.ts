...
import {
  ...
  resolveApiBaseUrl,
  revealViewerToken,
} from "../../application/viewer-integration.service.js";
import {
  hasViewerScope,
  scopeForIntegrationPath,
  type ViewerApiScope,
} from "../../application/viewer-scopes.service.js";
import {
...
} from "../../application/viewer-api-data.service.js";
import { PLATFORM_PREFIX, registerPlatformGet } from "../../../../shared/http/viewer-paths.js";

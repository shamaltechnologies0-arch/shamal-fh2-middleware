...
import type { Fh2Task } from "../../../../infrastructure/fh2/types.js";
import {
  normalizeMedia,
  normalizeTask,
  normalizeTrajectory,
...
export const taskRoutes: FastifyPluginAsync = async (app) => {
        ...
        querystring: {
          ...
          properties: {
            sn: {
              type: "string",
              description:
                "Optional Shamal device serialNumber from GET /v1/devices. Leave empty to use the first project device.",
  ...
  registerViewerGet(
    ...
    "/v1/tasks/:id",
    {
      schema: {
        ...
        description:
          "Use task id from GET /v1/tasks -> data[].id. This is a FlightHub task UUID, not an email address.",
        tags: ["Tasks"],
        params: {
          type: "object",
          required: ["id"],
          properties: {
            id: {
              type: "string",
              format: "uuid",
              description: "Task UUID copied from GET /v1/tasks -> data[].id",
            },
          },
        },
      },
  ...
  registerViewerGet(
    app,
    "/v1/tasks/:id/trajectory",
    {
      schema: {
        summary: "Get Shamal task trajectory",
        description:
          "Use task id from GET /v1/tasks -> data[].id. This returns the flight path for a task.",
        tags: ["Tasks"],
        params: {
          type: "object",
          required: ["id"],
  ...
  registerViewerGet(
    ...
    "/v1/tasks/:id/media",
    {
      schema: {
        ...
        description:
          "Use task id from GET /v1/tasks -> data[].id. This field is not an email address or user name.",
        tags: ["Tasks"],
        params: {
          type: "object",
          required: ["id"],
